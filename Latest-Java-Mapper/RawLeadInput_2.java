...
//        ↓
//    [1] POST /api/v1/consumer-score/trigger      (ConsumerScoreController)
//        ↓
...
FROM $lead_rec;
    ...
    public double callMlPredict(NormalizedLeadInput norm) {
        ...
        String sql = String.format("""
            ...
            LET $prediction = ml::consumer_score<1.0.0>([
                %f, -- primary_sentiment
                %f, -- sentiment_score
...
//      THEN {
//        http::post(
//          "http://your-java-api/api/v1/consumer-score/trigger",
...
class ConsumerScoreController {
    ...
    // Manual trigger for testing: POST /api/v1/consumer-score/score/lead:abc123
