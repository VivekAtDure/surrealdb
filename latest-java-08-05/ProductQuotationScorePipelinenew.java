...
//import com.dure.botbuilder.surreal.mapperservice.product.ProductQuotationController;
//import com.dure.botbuilder.surreal.mapperservice.product.ProductQuotationScorePipeline;
 ...
 */
@Service
public class ProductQuotationScorePipelinenew {
    private static final Logger log = LoggerFactory.getLogger(ProductQuotationScorePipelinenew.class);
    ...
    public ProductQuotationScorePipelinenew() {
...
FROM $lead_rec;
    ...
    private double callMlPredict(NormalizedProductQuotationInput norm) {
        ...
        String sql = String.format(Locale.US, """
            ...
            LET $prediction = ml::product_quotation_score<2.0.0>([
                %f, %f, %f, %f, %f, %f, %f, %f, %f, %f,
                %f, %f, %f, %f, %f, %f, %f
            ]);
...
// ── Mapper ───────────────────────────────────────────────────────────────────
@RestController
@RequestMapping("/api/v1/product-quotation-score")
class ProductQuotationController {

    private static final Logger log =
        LoggerFactory.getLogger(ProductQuotationController.class);

    private final ProductQuotationScorePipelinenew pipelineService;

    ProductQuotationController(ProductQuotationScorePipelinenew pipelineService) {
    ...
    // Manual trigger: POST /api/v1/product-quotation-score/score/lead:abc123
